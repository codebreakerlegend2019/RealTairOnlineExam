...
namespace EasyTwoJuetengApp.Helpers.JdsClientTool
{
    public static class JdsClient
    {
        ...
        public static async Task<JdsMultiResponse<T>> GetManyAsync<T>(string apiBaseLink, string token) where T : class
        {
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    if (!response.IsSuccessStatusCode) return new JdsMultiResponse<T>()
                    {
        ...
        public static async Task<JdsMultiResponse<T>> GetManyAsync<T>(string apiBaseLink) where T : new()
        {
            try
            {
        ...
        public static async Task<JdsMultiResponse<TResult>> PostAsyncWithMultiReturn<TPram, TResult>(string apiBaseAddres, TPram model, string token) where TResult : new()
        {
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    if (!response.IsSuccessStatusCode)
                    {
                        return new JdsMultiResponse<TResult>()
                        {
        ...
        public static async Task<JdsMultiResponse<TResult>> PostAsyncWithMultiReturn<TPram, TResult>(string apiBaseAddres, TPram model) where TResult : new()
        {
            try
            {
                using (var client = new HttpClient())
        ...
        public static async Task<JdsResponse> PostAsync<TPram>(string apiBaseAddres, TPram model, string token) where TPram : class
        {
            try
            {
                using (var client = new HttpClient())
